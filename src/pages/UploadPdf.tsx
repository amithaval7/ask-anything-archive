  ...
  return (
    <ArchiveLayout>
      <div className="max-w-3xl mx-auto space-y-6 p-6">
        <div>
          <h1 className="text-3xl font-bold mb-2">Upload PDF Document</h1>
          <p className="text-muted-foreground">
            Upload a PDF file to analyze and ask questions about its content
          </p>
        </div>
        ...
        <Card {...getRootProps()} className={`border-2 border-dashed p-10 text-center cursor-pointer ${isDragActive ? 'border-primary bg-primary/5' : 'border-border'}`}>
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            <div className="rounded-full bg-primary/10 p-6">
              <FileText className={`h-12 w-12 ${isDragActive ? 'text-primary' : 'text-red-500'}`} />
            </div>
            <div>
              <p className="font-medium text-lg">Drop your PDF here, or click to select</p>
